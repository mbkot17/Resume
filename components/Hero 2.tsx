  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[var(--background)] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div
          className="absolute top-1/4 -right-32 w-96 h-[600px] bw-decorative"
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-[var(--content-max-width)] relative z-10">
        ...
        >
          ...
          <motion.h1
            className="font-serif text-7xl sm:text-8xl lg:text-9xl font-bold mb-6 leading-[1.1] tracking-tight"
      ...
      >
        ...
        >
          <span className="text-xs text-[var(--muted)] tracking-wider uppercase">Scroll</span>
          <svg 
